...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Tvshow',
      item: 'https://moviescentral.vercel.app/tvshow/'
    }
  ]
})
...
const tvshowPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Tvshow | Movies Central™</title>
        <link rel='canonical' href='https://moviescentral.vercel.app/tvshow/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Tvshow |  Movies Central™' />
        <meta
          property='og:description'
          content='Welcome to Movies Central™ – Watch and enjoy HD streaming'
        />

        <meta property='og:url' content='https://moviescentral.vercel.app/tvshow' />
        ...
        <meta
          name='keywords'
          content='moviescentral, movies central, tvshow, watch free tvshow, watch tvshow online, download tvshow, watch full tvshow, watch hd tvshow'
        />
        <meta
          property='og:image'
          content='https://moviescentral.vercel.app/og_image.jpg'
