  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: adultp1Item.siteurl,
        name: `${adultp1Item.name} | Movies Central`,
        datePublished: adultp1Item.datePublished,
        dateModified: adultp1Item.dateModified,
        isPartOf: {
          '@id': 'https://moviescentral.vercel.app#website'
      ...
      },
      {
        ...
        headline: `Download ${adultp1Item.name} | Movies Central`,
        datePublished: adultp1Item.datePublished,
        dateModified: adultp1Item.dateModified,
        articleSection: 'adult',
        author: {
          '@id': 'https://moviescentral.vercel.appauthor/adultp1Item/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        ...
        image: adultp1Item.image,
        name: `Download ${adultp1Item.name} | Movies Central`,
        isPartOf: {
          '@id': `${adultp1Item.siteurl}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Download {adultp1Item && adultp1Item.name} | Movies Central</title>
        ...
        <meta
          property='og:title'
          content={`${adultp1Item && adultp1Item.name} - Movies Central`}
        />
        <meta
