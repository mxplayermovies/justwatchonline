...
const page5 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://moviescentral.vercel.app/page5',
    headline: 'Main Section 5 | Movies Central™',
    url: 'https://moviescentral.vercel.app/page5',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://moviescentral.vercel.app/page5'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 5 | Movies Central™</title>
        <link rel='canonical' href='https://moviescentral.vercel.app/page5' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 5 | Movies Central™' />
        <meta
        ...
        <meta property='og:url' content='https://moviescentral.vercel.app/page5' />
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://moviescentral.vercel.app/moviesp3.json');
