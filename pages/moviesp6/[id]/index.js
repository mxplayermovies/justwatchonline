      ...
      >
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>Movies Central™</strong>, your favorite TV series is
              just a click away.
            </p>
          </>
        )}
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              Streaming <strong>{moviesItem.title}</strong> on{' '}
              <strong>Movies Central™</strong> provides you with a
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{moviesItem.title}</strong> on{' '}
              <strong>Movies Central™</strong> is the perfect way to enjoy
