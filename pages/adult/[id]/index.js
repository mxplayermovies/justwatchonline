  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${adultItem.name} | Movies Central™`,
      ...
      },
      {
        ...
        headline: ` ${adultItem.name} | Movies Central™`,
        datePublished: adultItem.datePublished,
        dateModified: adultItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {adultItem && adultItem.name} | Movies Central™</title>
        ...
        <meta
          property='og:title'
          content={`${adultItem && adultItem.name} - Movies Central`}
        />
        <meta
          property='og:description'
          content='Welcome to Movies Central™ – your go-to spot for free online adult! Watch and enjoy HD streaming, and catch the latest adults. Dive into cinema with Movies Central™!'
        />
