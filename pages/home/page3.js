...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://moviescentral.vercel.app/page3',
  headline: 'Main Section 3 | Movies Central™™',
  url: 'https://moviescentral.vercel.app/page3',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://moviescentral.vercel.app/page3'
    }
  ]
})
...
const page3 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 3 | Movies Central™™</title>
        <link rel='canonical' href='https://moviescentral.vercel.app/page3' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 3 | Movies Central™™' />
        <meta
        ...
        <meta property='og:url' content='https://moviescentral.vercel.app/page3' />
