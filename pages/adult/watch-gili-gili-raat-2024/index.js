  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: adult.siteurl,
        name: `${adult.name} | Movies Central™`,
      ...
      },
      {
        ...
        headline: ` ${adult.name} | Movies Central™`,
        datePublished: adult.datePublished,
        dateModified: adult.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Gili Gili Raat (2024) | Movies Central™</title>
        ...
        <meta
          property='og:title'
          content={`${adult && adult.name} - Movies Central`}
        />
        <meta
