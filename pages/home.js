...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://moviescentral.vercel.app/home/',
  headline: 'Movies Section | Movies Central™',
  url: 'https://moviescentral.vercel.app/home/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://moviescentral.vercel.app/home/'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section | Movies Central™</title>
        <link rel='canonical' href='https://moviescentral.vercel.app/home/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section | Movies Central™' />
        <meta
...
//   try {
//     const res = await fetch('https://moviescentral.vercel.app/home.json')
