  ...
  return (
    <div>
      <Head>
        ...
        <link
          rel='canonical'
          href='https://moviescentral.vercel.app/intro/privacy'
        />
        ...
        <meta
          property='og:url'
          content='https://moviescentral.vercel.app/intro/privacy/'
        />
          ...
          <div className='flex flex-wrap'>
            <div className='grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6'>
              ...
              <p className='text-gray-500 mb-6'>
                Movies Central™ International(Movies Central™) is committed to
                protecting your privacy. This Privacy Policy applies only to the
                Web Sites and applications published by Movies Central™
                International.
              </p>
              <p className='font-bold mb-2'>Note: Use of Information</p>
              <p className='text-gray-500 mb-6'>Information that we collect </p>
              <p className='text-gray-500 mb-6'>
                Movies Central™ may collect information from its users in three
              ...
              <p className='text-gray-500'>
                ...
                advertisers of Movies Central™ free from any and all
                liability.This site (Movies Central™ ) do not offer any
