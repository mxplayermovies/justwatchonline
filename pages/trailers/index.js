...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Trailers',
      item: 'https://moviescentral.vercel.app/trailers/'
    }
  ]
})
...
const trailersPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
      <title>Watch Movies Trailers | Movies Central™</title>
        <link rel='canonical' href='https://moviescentral.vercel.app/trailers/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Trailers | Movies Central' />
        <meta
      ...
      content='Welcome to Movies Central™ – your go-to spot for free online movies! Watch and enjoy HD streaming, and catch the latest movies & tvshows. Dive into cinema with Movies Central™!'
        ...
        <meta property='og:url' content='https://moviescentral.vercel.app/trailers' />
      ...
      <Script src='../../propler/ads.js' defer />
        ...
        >
          Movies Central Trailer Section.
        </h1>
