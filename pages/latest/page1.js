...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://moviescentral.vercel.app/latest-page1/',
  headline: ' Latest Blog | Movies Central™',
  url: 'https://moviescentral.vercel.app/latest-page1/',
  description:
    'Movies Central is the top platform for exploring and downloading software,the premier platform for the Latest Blog releases and secure downloads.',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Latest Page 1',
      item: 'https://moviescentral.vercel.app/latest-page1/'
    }
  ]
})
...
const latestpage1Page = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title>  Latest Blog | Movies Central™</title>
        <link rel='canonical' href='https://moviescentral.vercel.app/latest-page1/' />
        <meta
          name='robots'
        ...
        <meta
          ...
          content='Movies Central is the top platform for exploring and downloading software,the premier platform for the latest-page1 releases and secure downloads.'
        />

        <meta
          property='og:url'
          content='https://moviescentral.vercel.app/latest-page1'
        />
      ...
      >
        Movies Central Latest Blog Blog Section.
      </h1>
      {/* <Marquee /> */}
      {/* <p
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://moviescentral.vercel.app/latestp1.json')
