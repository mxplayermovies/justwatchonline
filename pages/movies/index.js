...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch movies | Movies Central™</title>
        <link rel='canonical' href='https://moviescentral.vercel.app/movies/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch movies | Movies Central™' />
        <meta
          property='og:description'
          content='Welcome to Movies Central™ | Dive into Cinema & Tv Show!'
        />

        <meta property='og:url' content='https://moviescentral.vercel.app/movies' />
