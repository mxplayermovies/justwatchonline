        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>Movies Central™</strong> ensures that you won't miss a single
              moment of the action, drama, or comedy that makes this TV series a
              must-watch. With high-quality streaming and user-friendly
              navigation, <strong>Movies Central™</strong> provides everything you
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{moviesItem.title}</strong> on <strong>Movies Central™</strong>{' '}
              ...
              <strong>Movies Central™</strong>, your favorite TV series is just a
              click away.
            </p>
          </>
        )}
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>Movies Central™</strong>, we offer a vast library of premium
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>Movies Central™</strong>. Our platform ensures your privacy and
              security while you enjoy the content you love. Start streaming{' '}
              <strong>{moviesItem.title}</strong> today and discover why{' '}
              <strong>Movies Central™</strong> is the trusted choice for adult
              content.
            </p>
          </>
        )}
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              here. At <strong>Movies Central™</strong>, we bring you the best in
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>Movies Central™</strong>, your entertainment is just a click
              away.
            </p>
          </>
        )}
