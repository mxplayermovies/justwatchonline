...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://moviescentral.vercel.app/trailers/',
  headline: 'Watch Online Trailers | Movies Central™',
  url: 'https://moviescentral.vercel.app/trailers/',
  description:
    'Welcome to Movies Central™ – your go-to spot for free online trailers! Watch and enjoy HD streaming, and catch the latest tvshows. Dive into cinema with Movies Central™!',
...
const trailersPage1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Trailers | Movies Central™</title>
        ...
        <meta property='og:title' content=' Watch Online Trailers | Movies Central' />
        <meta
          property='og:description'
          content='Welcome to Movies Central™ – your go-to spot for free online trailers! Watch and enjoy HD streaming, and catch the latest tvshows. Dive into cinema with Movies Central™!'
        />
        ...
        <meta
          name='keywords'
          content='aztrailers, Movies Central, a-z trailers, az trailers, watch free trailers, watch trailers online, download trailers, watch full trailers, watch hd trailers'
        />
        <meta
          property='og:image'
          content='https://moviescentral.vercel.app/og_image.jpg'
      ...
      <Script src='../../propler/ads2.js' defer />
        ...
        >
          Movies Central trailers Section.
        </h1>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://moviescentral.vercel.app/trailersp1.json')
