...
const Privacy = () => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      {
        '@type': 'Person',
        '@id': 'https://moviescentral.vercel.app/author/ytmag/',
        name: 'Dr Trailer',
        url: 'https://moviescentral.vercel.app/author/ytmag/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        name: 'moviescentral - Explore. Discover. Connect..',
  ...
  return (
    <div>
       <Head>
        <title>moviescentral | Privacy Policy</title>
        ...
        <link
          ...
          <meta
            name='keywords'
            content='moviescentral, Movies Central, a-z movies, az movies, watch free movies, watch movies online, download movies, watch full movies, watch hd movies'
          />
...
<section className="mb-32 text-gray-800">
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">moviescentral </p>
      <p className="text-gray-500 mb-6">
      moviescentral International(moviescentral) is committed to protecting your privacy. This Privacy Policy applies only to the Web Sites and applications published by moviescentral International.
      </p>
      <p className="font-bold mb-2">Note: Use of Information</p>
      <p className="text-gray-500 mb-6">
      Information that we collect  </p>
      <p className="text-gray-500 mb-6">
      moviescentral may collect information from its users in three different ways: directly from the user, from traffic references of hostingservers and from cookies.
      </p>
     ...
     2. As otherwise described to you at the point of collection or with your consent.  
      ...
      We do not make warranties that this site will operate error free. If you see an error, please contact the <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com ">webmaster</a>. By entering this site you agree to hold the owners, employees, advertisers of moviescentral  free from any and all liability.This site (moviescentral ) do not offer any membership.If you have any questions please feel free to <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com">contact us</a>.
      </p>
    </div>
