...
const softwareSchema = JSON.stringify({
  ...
  description:
    'Welcome to Movies Central™ | Dive into Cinema & Tv Show!',
  image: 'https://moviescentral.vercel.app/wp-content/uploads/tvshow.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const tvshowPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Movies Central™ - Tv Show Section.</title>
        <link
          rel='canonical'
          href='https://moviescentral.vercel.app/tvshow/'
        />
        <meta
          name='robots'
        ...
        <meta
          property='og:url'
          content='https://moviescentral.vercel.app/tvshow'
        />
     ...
     content='movies central, free movies, stream movies, watch free movies, watch movies online, download movies, watch full movies, watch hd movies'
      ...
      >
        Latest Movies Central™ - Tv Show Section.
      </h1>
