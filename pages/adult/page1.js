  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
     <Head>
        ...
        <link
          rel='canonical'
          href='https://moviescentral.vercel.app/page1/'
        />
        <meta
          name='robots'
        ...
        <meta
          ...
          content='https://moviescentral.vercel.app/wp-content/uploads/og_image.jpg'
        />
           <meta
        ...
        <meta
          name='keywords'
          content='Movies Central, Movies Central, a-z adult, az adult, watch free adult, watch adult online, download adult, watch full adult, watch hd adult'
        />
        <meta
          property='og:image'
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://moviescentral.vercel.app/adultp1.json')
