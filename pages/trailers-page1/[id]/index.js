  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: trailersp1Item.siteurl,
        name: `${trailersp1Item.name} | Movies Central`,
        datePublished: trailersp1Item.datePublished,
        dateModified: trailersp1Item.dateModified,
        isPartOf: {
          '@id': 'https://moviescentral.vercel.app#website'
      ...
      },
      {
        ...
        headline: `Download ${trailersp1Item.name} | Movies Central`,
        datePublished: trailersp1Item.datePublished,
        dateModified: trailersp1Item.dateModified,
        articleSection: 'games',
        author: {
          '@id': 'https://moviescentral.vercel.appauthor/trailersp1Item/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        ...
        image: trailersp1Item.image,
        name: `Download ${trailersp1Item.name} | Movies Central`,
        isPartOf: {
          '@id': `${trailersp1Item.siteurl}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Download {trailersp1Item && trailersp1Item.name} | Movies Central</title>
        ...
        <meta
          property='og:title'
          content={`${trailersp1Item && trailersp1Item.name} - Movies Central`}
        />
        <meta
          property='og:description'
          content='Movies Central is the top platform for exploring and downloading software,the premier platform for the latest releases and secure downloads.'
        />
