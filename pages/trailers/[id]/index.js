  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${trailersItem.name} | Movies Central™`,
      ...
      },
      {
        ...
        headline: ` ${trailersItem.name} | Movies Central™`,
        datePublished: trailersItem.datePublished,
        dateModified: trailersItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        <title>
          {' '}
           {trailersItem && trailersItem.name} | Movies Central™
        </title>
        ...
        <meta
          property='og:title'
          content={`${trailersItem && trailersItem.name} - Movies Central`}
        />
        <meta
