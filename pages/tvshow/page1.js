...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://moviescentral.vercel.app/tvshow/',
  headline: 'Watch Online Tvshow | Movies Central™',
  url: 'https://moviescentral.vercel.app/tvshow/',
  description:
    'Welcome to Movies Central™ – your go-to spot for free online tvshow! Watch and enjoy HD streaming, and catch the latest tvshows. Dive into cinema with Movies Central™!',
...
const tvshowPage1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Tvshow | Movies Central™</title>
        ...
        <meta property='og:title' content=' Watch Online tvshow | Movies Central' />
        <meta
          property='og:description'
          content='Welcome to Movies Central™ – your go-to spot for free online tvshow! Watch and enjoy HD streaming, and catch the latest tvshows. Dive into cinema with Movies Central™!'
        />
        ...
        <meta
          name='keywords'
          content='aztvshow, Movies Central, a-z tvshow, az tvshow, watch free tvshow, watch tvshow online, download tvshow, watch full tvshow, watch hd tvshow'
        />
        <meta
          property='og:image'
          content='https://moviescentral.vercel.app/og_image.jpg'
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://moviescentral.vercel.app/tvshowp1.json')
