  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${tvshowItem.name} | Movies Central™`,
      ...
      },
      {
        ...
        headline: ` ${tvshowItem.name} | Movies Central™`,
        datePublished: tvshowItem.datePublished,
        dateModified: tvshowItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {tvshowItem && tvshowItem.name} | Movies Central™</title>
        ...
        <meta
          property='og:title'
          content={`${tvshowItem && tvshowItem.name} - Movies Central`}
        />
        <meta
