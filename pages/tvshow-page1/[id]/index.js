  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${tvshowp1Item.name} | Movies Central™`,
      ...
      {
        '@type': 'Person',
        '@id': 'https://moviescentral.vercel.app/author/aztvshow/',
        name: 'Dr Trailer',
        url: 'https://moviescentral.vercel.app/author/aztvshow/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        headline: `Watch ${tvshowp1Item.name} | Movies Central™`,
        datePublished: tvshowp1Item.datePublished,
        dateModified: tvshowp1Item.dateModified,
        articleSection: 'Tv Show',
        author: {
          '@id': 'https://moviescentral.vercel.appauthor/tvshowp1Item/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        ...
        name: `Watch ${tvshowp1Item.name} | Movies Central™`,
        isPartOf: {
          '@id': `${tvshowp1Item.siteurl}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch {tvshowp1Item && tvshowp1Item.name} | Movies Central™</title>
        ...
        <meta
          property='og:title'
          content={`${tvshowp1Item && tvshowp1Item.name} - Movies Central`}
        />
        <meta
