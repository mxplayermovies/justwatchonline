  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${latestp1.name} | Movies Central`,
      ...
      {
        '@type': 'Person',
        '@id': 'https://moviescentral.vercel.appauthor/latestp1/',
        name: 'Dr Trailer',
        url: 'https://moviescentral.vercel.appauthor/latestp1/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        headline: `Watch ${latestp1.name} | Movies Central`,
        datePublished: '2024-01-13T13:00:00+00:00',
        dateModified: '2024-01-13T13:13:00+00:00',
        ...
        name: `Watch ${latestp1.name} | Movies Central`,
        isPartOf: {
          '@id': `/${latestp1['latestp1.watch']}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch {latestp1 && latestp1.name} | Movies Central</title>
        ...
        <meta
          property='og:title'
          content={`${latestp1 && latestp1.name} - Movies Central`}
        />

        <meta
          property='og:description'
          content='Movies Central is the top platform for exploring and downloading software,the premier platform for the latestp1 releases and secure downloads.'
        />
      ...
      >
        ...
        >
          Welcome to Movies Central Latest Blog Software News.
        </h1>
        {/* 
        <p
